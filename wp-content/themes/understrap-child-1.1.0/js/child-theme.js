...
(function (global, factory) {
  ...
  (function (module, exports) {
    (function (global, factory) {
      ...
      commonjsGlobal,
      function (EventHandler, Manipulator, SelectorEngine, BaseComponent) {
        const _interopDefaultLegacy = (e) =>
          e && typeof e === "object" && "default" in e ? e : { default: e };

        const EventHandler__default =
          /*#__PURE__*/ _interopDefaultLegacy(EventHandler);
        const Manipulator__default =
          /*#__PURE__*/ _interopDefaultLegacy(Manipulator);
        ...
        class Carousel extends BaseComponent__default.default {
          ...
          _triggerSlideEvent(relatedTarget, eventDirectionName) {
            ...
            return EventHandler__default.default.trigger(
              this._element,
              EVENT_SLIDE,
              {
                relatedTarget,
          ...
          _slide(directionOrOrder, element) {
            ...
            if (
              nextElement &&
              nextElement.classList.contains(CLASS_NAME_ACTIVE)
            ) {
              this._isSliding = false;
              return;
            }
        ...
        EventHandler__default.default.on(window, EVENT_LOAD_DATA_API, () => {
          const carousels =
            SelectorEngine__default.default.find(SELECTOR_DATA_RIDE);
      ...
      function (
        ...
        class Collapse extends BaseComponent__default.default {
          constructor(element, config) {
            ...
            this._triggerArray = [];
            const toggleList =
              SelectorEngine__default.default.find(SELECTOR_DATA_TOGGLE);
          ...
          show() {
            ...
            const container = SelectorEngine__default.default.findOne(
              this._selector
            );
            ...
            const startEvent = EventHandler__default.default.trigger(
              this._element,
              EVENT_SHOW
            );
        ...
        EventHandler__default.default.on(
          ...
          function (event) {
            ...
            const selectorElements =
              SelectorEngine__default.default.find(selector);
  ...
  function getClippingParents(element) {
    ...
    return clippingParents.filter(function (clippingParent) {
      return (
        ...
        (canEscapeClipping
          ? getComputedStyle$1(clippingParent).position !== "static"
          : true)
      );
    });
      ...
      function (
        ...
        class Dropdown extends BaseComponent__default.default {
          ...
          _completeHide(relatedTarget) {
            ...
            Manipulator__default.default.removeDataAttribute(
              this._menu,
              "popper"
            );
            EventHandler__default.default.trigger(
          ...
          _getMenuElement() {
            return SelectorEngine__default.default.next(
              this._element,
              SELECTOR_MENU
            )[0];
          }
          ...
          static dataApiKeydownHandler(event) {
            ...
            const getToggleButton = this.matches(SELECTOR_DATA_TOGGLE)
              ? this
              : SelectorEngine__default.default.prev(
                  this,
                  SELECTOR_DATA_TOGGLE
                )[0];
      ...
      function (EventHandler, Manipulator, SelectorEngine, BaseComponent) {
        ...
        class FocusTrap {
          ...
          _handleFocusin(event) {
            ...
            const elements =
              SelectorEngine__default.default.focusableChildren(trapElement);
        ...
        EventHandler__default.default.on(
          ...
          function (event) {
            ...
            const allReadyOpen =
              SelectorEngine__default.default.findOne(OPEN_SELECTOR);
  ...
  (function (module, exports) {
    (function (global, factory) {
      ...
      commonjsGlobal,
      function (SelectorEngine, Manipulator, EventHandler, BaseComponent) {
        const _interopDefaultLegacy = (e) =>
          e && typeof e === "object" && "default" in e ? e : { default: e };
      ...
      function (EventHandler, Manipulator, SelectorEngine, BaseComponent) {
        ...
        class ScrollSpy extends BaseComponent__default.default {
              ...
              .map((element) => {
                ...
                if (target) {
                  ...
                  if (targetBCR.width || targetBCR.height) {
                    return [
                      Manipulator__default.default[offsetMethod](target).top +
                        offsetBase,
                      targetSelector,
                    ];
                  }
          ...
          _activate(target) {
            ...
            const link = SelectorEngine__default.default.findOne(
              queries.join(","),
              this._config.target
            );
